...
class _Window(PandasObject, SelectionMixin):
    ...
    win_freq: Any = ...
    axis: Any = ...
    def __init__(self, obj: Any, window: Optional[Any] = ..., min_periods: Optional[Any] = ..., center: bool = ..., win_type: Optional[Any] = ..., axis: int = ..., on: Optional[Any] = ..., closed: Optional[Any] = ..., **kwargs: Any) -> None: ...
    @property
...
class _Rolling_and_Expanding(_Rolling):
    def count(self): ...
    def apply(self, func: Any, raw: Optional[Any] = ..., args: Any = ..., kwargs: Any = ...): ...
    def sum(self, *args: Any, **kwargs: Any): ...
