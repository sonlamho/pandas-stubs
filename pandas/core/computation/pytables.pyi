...
class Scope(expr.Scope):
    queryables: Any = ...
    def __init__(self, level: Any, global_dict: Optional[Any] = ..., local_dict: Optional[Any] = ..., queryables: Optional[Any] = ...) -> None: ...
...
class Expr(expr.Expr):
    ...
    expr: Any = ...
    env: Any = ...
    def __init__(self, where: Any, queryables: Optional[Any] = ..., encoding: Optional[Any] = ..., scope_level: int = ...) -> None: ...
    def __unicode__(self): ...
    def evaluate(self): ...
