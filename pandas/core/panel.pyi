...
class Panel(NDFrame):
    def __init__(
        ...
        data: Optional[Any] = ...,
        items: Optional[Any] = ...,
        major_axis: Optional[Any] = ...,
        minor_axis: Optional[Any] = ...,
        copy: bool = ...,
        dtype: Optional[Any] = ...,
    ) -> None: ...
    @classmethod
    ...
    def to_excel(
        self, path: Any, na_rep: str = ..., engine: Optional[Any] = ..., **kwargs: Any
    ) -> None: ...
    def as_matrix(self): ...
    ...
    def tshift(
        self, periods: int = ..., freq: Optional[Any] = ..., axis: str = ...
    ): ...
    def join(
        self, other: Any, how: str = ..., lsuffix: str = ..., rsuffix: str = ...
    ): ...
    def update(
        self,
        other: Any,
