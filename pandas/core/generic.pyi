...
class NDFrame(PandasObject, SelectionMixin):
    timetuple: Any = ...
    def __init__(self, data: Any, axes: Optional[Any] = ..., copy: bool = ..., dtype: Optional[Any] = ..., fastpath: bool = ...) -> None: ...
    @property
    def is_copy(self): ...
    @is_copy.setter
    ...
    columns: Optional[Any] = ..., header: bool = ..., index: bool = ...,
    index_label: Optional[Any] = ..., startrow: int = ..., startcol: int = ...,
    engine: Optional[Any] = ..., merge_cells: bool = ...,
    encoding: Optional[Any] = ..., inf_rep: str = ..., verbose: bool = ...,
    freeze_panes: Optional[Any] = ...) -> None: ...
    def to_json(self, path_or_buf: Optional[Any] = ..., orient: Optional[Any] = ..., date_format: Optional[Any] = ..., double_precision: int = ..., force_ascii: bool = ..., date_unit: str = ..., default_handler: Optional[Any] = ...,
    ...
    def to_sql(self, name: Any, con: Any, schema: Optional[Any] = ..., if_exists: str = ..., index: bool = ..., index_label: Optional[Any] = ..., chunksize: Optional[Any] = ..., dtype: Optional[Any] = ..., method: Optional[Any] = ...) -> None: ...
    def to_pickle(self, path: Any, compression: str = ..., protocol: Any = ...): ...
    def to_clipboard(self, excel: bool = ..., sep: Optional[Any] = ..., **kwargs: Any) -> None: ...
    def to_xarray(self): ...
    def to_latex(self, buf: Optional[Any] = ..., columns: Optional[Any] = ..., col_space: Optional[Any] = ..., header: bool = ..., index: bool = ..., na_rep: str = ..., formatters: Optional[Any] = ..., float_format: Optional[Any] = ..., sparsify: Optional[Any] = ..., index_names: bool = ..., bold_rows: bool = ..., column_format: Optional[Any] = ..., longtable: Optional[Any] = ..., escape: Optional[Any] = ..., encoding: Optional[Any] = ..., decimal: str = ..., multicolumn: Optional[Any] = ..., multicolumn_format: Optional[Any] = ..., multirow: Optional[Any] = ...): ...
    def to_csv(self, path_or_buf: Optional[Any] = ..., sep: str = ..., na_rep: str = ..., float_format: Optional[Any] = ..., columns: Optional[Any] = ..., header: bool = ..., index: bool = ..., index_label: Optional[Any] = ..., mode: str = ..., encoding: Optional[Any] = ..., compression: str = ..., quoting: Optional[Any] = ..., quotechar: str = ..., line_terminator: Optional[Any] = ..., chunksize: Optional[Any] = ..., tupleize_cols: Optional[Any] = ..., date_format: Optional[Any] = ..., doublequote: bool = ..., escapechar: Optional[Any] = ..., decimal: str = ...): ...
    def get(self, key: Any, default: Optional[Any] = ...): ...
    def __getitem__(self, item: Any): ...
    def __delitem__(self, key: Any) -> None: ...
    def take(self, indices: Any, axis: int = ..., convert: Optional[Any] = ..., is_copy: bool = ..., **kwargs: Any): ...
    def xs(self, key: Any, axis: int = ..., level: Optional[Any] = ..., drop_level: bool = ...): ...
    def select(self, crit: Any, axis: int = ...): ...
    def reindex_like(self, other: Any, method: Optional[Any] = ..., copy: bool = ..., limit: Optional[Any] = ..., tolerance: Optional[Any] = ...): ...
    ...
    @property
    def blocks(self): ...
    def astype(self, dtype: Any, copy: bool = ..., errors: str = ..., **kwargs: Any): ...
    ...
    def notna(self): ...
    def notnull(self): ...
    def clip(self, lower: Optional[Any] = ..., upper: Optional[Any] = ..., axis: Optional[Any] = ..., inplace: bool = ..., *args: Any, **kwargs: Any): ...
    def clip_upper(self, threshold: Any, axis: Optional[Any] = ..., inplace: bool = ...): ...
    def clip_lower(self, threshold: Any, axis: Optional[Any] = ..., inplace: bool = ...): ...
    def groupby(self, by: Optional[Any] = ..., axis: int = ..., level: Optional[Any] = ..., as_index: bool = ..., sort: bool = ..., group_keys: bool = ..., squeeze: bool = ..., observed: bool = ..., **kwargs: Any): ...
    def asfreq(self, freq: Any, method: Optional[Any] = ..., how: Optional[Any] = ..., normalize: bool = ..., fill_value: Optional[Any] = ...): ...
    def at_time(self, time: Any, asof: bool = ..., axis: Optional[Any] = ...): ...
    def between_time(self, start_time: Any, end_time: Any, include_start: bool = ..., include_end: bool = ..., axis: Optional[Any] = ...): ...
    ...
    def rank(self, axis: int = ..., method: str = ..., numeric_only: Optional[Any] = ..., na_option: str = ..., ascending: bool = ..., pct: bool = ...): ...
    ...
    def where(self, cond: Any, other: Any = ..., inplace: bool = ..., axis: Optional[Any] = ..., level: Optional[Any] = ..., errors: str = ..., try_cast: bool = ..., raise_on_error: Optional[Any] = ...): ...
    def mask(self, cond: Any, other: Any = ..., inplace: bool = ..., axis: Optional[Any] = ..., level: Optional[Any] = ..., errors: str = ..., try_cast: bool = ..., raise_on_error: Optional[Any] = ...): ...
    ...
    def tz_convert(self, tz: Any, axis: int = ..., level: Optional[Any] = ..., copy: bool = ...): ...
    def tz_localize(self, tz: Any, axis: int = ..., level: Optional[Any] = ..., copy: bool = ..., ambiguous: str = ..., nonexistent: str = ...): ...
    def abs(self): ...
