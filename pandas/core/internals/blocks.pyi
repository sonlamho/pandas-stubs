...
class Block(PandasObject):
    ...
    values: Any = ...
    def __init__(
        self, values: Any, placement: Any, ndim: Optional[Any] = ...
    ) -> None: ...
    @property
    def is_view(self): ...
    @property
    ...
    def make_block(
        self, values: Any, placement: Optional[Any] = ..., ndim: Optional[Any] = ...
    ): ...
...
class ObjectBlock(Block):
    is_object: bool = ...
    def __init__(
        self, values: Any, placement: Optional[Any] = ..., ndim: int = ...
    ) -> None: ...
    @property
    def is_bool(self): ...
