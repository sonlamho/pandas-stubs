...
class BlockManager(PandasObject):
    ...
    blocks: Any = ...
    def __init__(
        self, blocks: Any, axes: Any, do_integrity_check: bool = ...
    ) -> None: ...
    ...
    def rename_axis(
        self, mapper: Any, axis: Any, copy: bool = ..., level: Optional[Any] = ...
    ): ...
    @property
    def items(self): ...
    ...
    def replace_list(
        self, src_list: Any, dest_list: Any, inplace: bool = ..., regex: bool = ...
    ): ...
    ...
    def insert(
        self, loc: Any, item: Any, value: Any, allow_duplicates: bool = ...
    ) -> None: ...
    def reindex_axis(
        self,
        new_index: Any,
    ...
    def take(
        self, indexer: Any, axis: int = ..., verify: bool = ..., convert: bool = ...
    ): ...
...
def construction_error(
    tot_items: Any, block_shape: Any, axes: Any, e: Optional[Any] = ...
) -> None: ...
...
def concatenate_block_managers(
    mgrs_indexers: Any, axes: Any, concat_axis: Any, copy: Any
): ...
