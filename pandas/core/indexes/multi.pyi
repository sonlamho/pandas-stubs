...
class MultiIndex(Index):
    rename: Any = ...
    def __new__(cls, levels: Optional[Any] = ..., codes: Optional[Any] = ..., sortorder: Optional[Any] = ..., names: Optional[Any] = ..., dtype: Optional[Any] = ..., copy: bool = ..., name: Optional[Any] = ..., verify_integrity: bool = ..., _set_identity: bool = ...): ...
    @classmethod
    def from_arrays(cls, arrays: Any, sortorder: Optional[Any] = ..., names: Optional[Any] = ...): ...
    @classmethod
    def from_tuples(cls, tuples: Any, sortorder: Optional[Any] = ..., names: Optional[Any] = ...): ...
    @classmethod
    def from_product(cls, iterables: Any, sortorder: Optional[Any] = ..., names: Optional[Any] = ...): ...
    @classmethod
    ...
    @property
    def labels(self): ...
    def set_labels(self, labels: Any, level: Optional[Any] = ..., inplace: bool = ..., verify_integrity: bool = ...): ...
