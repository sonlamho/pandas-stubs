...
class Series(base.IndexOpsMixin, generic.NDFrame):
    ...
    def map(self, arg: Any, na_action: Optional[Any] = ...) -> Series: ...
    ...
    def notna(self): ...
    def notnull(self): ...
    def dropna(self, axis: int = ..., inplace: bool = ..., **kwargs: Any) -> Series: ...
    ...
    def __lt__(self, other: Union[Series,_NUMBER]) -> Series: ... # type: ignore
    def __gt__(self, other: Union[Series,_NUMBER]) -> Series: ... # type: ignore
    def __le__(self, other: Union[Series,_NUMBER]) -> Series: ... # type: ignore
    def __ge__(self, other: Union[Series,_NUMBER]) -> Series: ... # type: ignore
    def __and__(self, other: Series) -> Series: ...
    def __or__(self, other: Series) -> Series: ...
    def __xor__(self, other: Series) -> Series: ...
    def __mul__(self, other: Union[Series,_NUMBER]) -> Series: ...
    def __add__(self, other: Union[Series,_NUMBER]) -> Series: ...
...
class DataFrame(NDFrame):
    ...
    @overload
    def __getitem__(self, key: ndarray) -> DataFrame: ...
    ...
    def notna(self): ...
    def notnull(self): ...
    def dropna(self, axis: int = ..., how: str = ..., thresh: Optional[Any] = ..., subset: Optional[Any] = ..., inplace: bool = ...) -> DataFrame: ...
    ...
    def __lt__(self, other: Union[DataFrame,_NUMBER]) -> DataFrame: ... # type: ignore
    def __gt__(self, other: Union[DataFrame,_NUMBER]) -> DataFrame: ... # type: ignore
    def __le__(self, other: Union[DataFrame,_NUMBER]) -> DataFrame: ... # type: ignore
    def __ge__(self, other: Union[DataFrame,_NUMBER]) -> DataFrame: ... # type: ignore
    def __mul__(self, other: _NUMBER) -> DataFrame: ...
    def __rmul__(self, other: _NUMBER) -> DataFrame: ...
    def __add__(self, other: _NUMBER) -> DataFrame: ...
    def __radd__(self, other: _NUMBER) -> DataFrame: ...
    def __sub__(self, other: _NUMBER) -> DataFrame: ...
    def __rsub__(self, other: _NUMBER) -> DataFrame: ...
