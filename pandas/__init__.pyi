...
from typing import Any, Optional, Iterator, Union, TypeVar, overload, Sequence, List, Tuple, MutableSequence, Type, Generic, Mapping, Sized, Iterable, Hashable, Callable
...
class Series(base.IndexOpsMixin, NDFrame, Sequence, Sized):
    ...
    def sort_values(self: _S, axis: int = ..., ascending: bool = ..., inplace: bool = ..., kind: str = ..., na_position: str = ...) -> _S: ...
    def sort_index(self: _S, axis: int = ..., level: Optional[Any] = ..., ascending: bool = ..., inplace: bool = ..., kind: str = ..., na_position: str = ..., sort_remaining: bool = ...) -> _S: ...
    ...
    def apply(self: _S, func: Any, convert_dtype: bool = ..., args: Any = ..., **kwds: Any) -> _S: ...
    ...
    def drop(self: _S, labels: Optional[Any] = ..., axis: int = ..., index: Optional[Any] = ..., columns: Optional[Any] = ..., level: Optional[Any] = ..., inplace: bool = ..., errors: str = ...) -> _S: ...
    def fillna(self: _S, value: Optional[Any] = ..., method: Optional[Any] = ..., axis: Optional[Any] = ..., inplace: bool = ..., limit: Optional[Any] = ..., downcast: Optional[Any] = ..., **kwargs: Any) -> _S: ...
    ...
    def __lt__(self: _S, other: Union[_S, _NUMBER]) -> _S: ...
    def __gt__(self: _S, other: Union[_S, _NUMBER]) -> _S: ...
    def __le__(self: _S, other: Union[_S, _NUMBER]) -> _S: ...
    def __ge__(self: _S, other: Union[_S, _NUMBER]) -> _S: ...
    ...
    def __add__(self: _S, other: Union[_S, _NUMBER]) -> _S: ...
...
class DataFrame(NDFrame):
    ...
    @property
    def style(self): ...
    def iteritems(self) -> Iterator: ...  # type: ignore[override]
    ...
    def reindex_axis(self: _S, labels: Any, axis: int = ..., method: Optional[Any] = ..., level: Optional[Any] = ..., copy: bool = ..., limit: Optional[Any] = ..., fill_value: Optional[Any] = ...) -> _S: ...
    def drop(self: _S, labels: Optional[Any] = ..., axis: int = ..., index: Optional[Any] = ..., columns: Optional[Any] = ..., level: Optional[Any] = ..., inplace: bool = ..., errors: str = ...) -> _S: ...
    def rename(self, *args: Any, **kwargs: Any): ...
    def fillna(self: _S, value: Optional[Any] = ..., method: Optional[Any] = ..., axis: Optional[Any] = ..., inplace: bool = ..., limit: Optional[Any] = ..., downcast: Optional[Any] = ..., **kwargs: Any) -> _S: ...
    def replace(self, to_replace: Optional[Any] = ..., value: Optional[Any] = ..., inplace: bool = ..., limit: Optional[Any] = ..., regex: bool = ..., method: str = ...): ...
    def shift(self, periods: int = ..., freq: Optional[Any] = ..., axis: int = ..., fill_value: Optional[Any] = ...): ...
    def set_index(self: _S, keys: Any, drop: bool = ..., append: bool = ..., inplace: bool = ..., verify_integrity: bool = ...) -> _S: ...
    def reset_index(self: _S, level: Optional[Any] = ..., drop: bool = ..., inplace: bool = ..., col_level: int = ..., col_fill: str = ...) -> _S: ...
    def isna(self): ...
    def isnull(self): ...
    def notna(self): ...
    def notnull(self): ...
    def dropna(self: _S, axis: int = ..., how: str = ..., thresh: Optional[Any] = ..., subset: Optional[Any] = ..., inplace: bool = ...) -> _S: ...
    def drop_duplicates(self: _S, subset: Optional[Any] = ..., keep: str = ..., inplace: bool = ...) -> _S: ...
    def duplicated(self, subset: Optional[Any] = ..., keep: str = ...): ...
    def sort_values(self: _S, by: Any, axis: int = ..., ascending: bool = ..., inplace: bool = ..., kind: str = ..., na_position: str = ...) -> _S: ...
    def sort_index(self: _S, axis: int = ..., level: Optional[Any] = ..., ascending: bool = ..., inplace: bool = ..., kind: str = ..., na_position: str = ..., sort_remaining: bool = ..., by: Optional[Any] = ...) -> _S: ...
...
class DatetimeIndex(Sequence[Timestamp]):
    ...
    def get_values(self) -> ndarray: ...
    def __len__(self) -> int: ...
    def __getitem__(self, key: Union[int, slice]) -> Timestamp: ...  # type: ignore[override]

def date_range(start: Optional[Any] = ..., end: Optional[Any] = ..., periods: Optional[Any] = ..., freq: Optional[Any] = ..., tz: Optional[Any] = ..., normalize: bool = ..., name: Optional[Any] = ..., closed: Optional[Any] = ..., **kwargs: Any) -> DatetimeIndex: ...
