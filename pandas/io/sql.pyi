...
def execute(
    sql: Any, con: Any, cur: Optional[Any] = ..., params: Optional[Any] = ...
): ...
def read_sql_table(
    table_name: Any,
    con: Any,
...
class SQLTable(PandasObject):
    ...
    def insert(
        self, chunksize: Optional[Any] = ..., method: Optional[Any] = ...
    ) -> None: ...
    def read(
        self,
        coerce_float: bool = ...,
...
class SQLDatabase(PandasSQL):
    ...
    meta: Any = ...
    def __init__(
        self, engine: Any, schema: Optional[Any] = ..., meta: Optional[Any] = ...
    ) -> None: ...
