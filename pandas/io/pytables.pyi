...
class Fixed(StringMixin):
    ...
    def delete(self, where: Optional[Any] = ..., start: Optional[Any] = ..., stop: Optional[Any] = ..., **kwargs: Any) -> None: ...
...
class Table(Fixed):
    ...
    @property
    def indexables(self): ...
    def create_index(self, columns: Optional[Any] = ..., optlevel: Optional[Any] = ..., kind: Optional[Any] = ...) -> None: ...
    ...
    def read_column(self, column: Any, where: Optional[Any] = ..., start: Optional[Any] = ..., stop: Optional[Any] = ...): ...
...
class AppendableTable(LegacyTable):
    ...
    def write_data_chunk(self, rows: Any, indexes: Any, mask: Any, values: Any) -> None: ...
    selection: Any = ...
...
class Selection:
    ...
    terms: Any = ...
    coordinates: Any = ...
    def __init__(self, table: Any, where: Optional[Any] = ..., start: Optional[Any] = ..., stop: Optional[Any] = ...) -> None: ...
