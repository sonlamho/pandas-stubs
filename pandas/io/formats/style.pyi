...
class Styler:
    ...
    def __init__(
        ...
        table_styles: Optional[Any] = ...,
        uuid: Optional[Any] = ...,
        caption: Optional[Any] = ...,
        table_attributes: Optional[Any] = ...,
        cell_ids: bool = ...,
    ) -> None: ...
    def to_excel(
        self,
    ...
    def clear(self) -> None: ...
    def apply(
        self, func: Any, axis: int = ..., subset: Optional[Any] = ..., **kwargs: Any
    ): ...
    ...
    def highlight_max(
        self, subset: Optional[Any] = ..., color: str = ..., axis: int = ...
    ): ...
    def highlight_min(
        self, subset: Optional[Any] = ..., color: str = ..., axis: int = ...
    ): ...
