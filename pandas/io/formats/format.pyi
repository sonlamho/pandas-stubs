...
def format_array(values: Any, formatter: Any, float_format: Optional[Any] = ..., na_rep: str = ..., digits: Optional[Any] = ..., space: Optional[Any] = ..., justify: str = ..., decimal: str = ..., leading_space: Optional[Any] = ...): ...
...
class GenericArrayFormatter:
    ...
    fixed_width: Any = ...
    leading_space: Any = ...
    def __init__(self, values: Any, digits: int = ..., formatter: Optional[Any] = ..., na_rep: str = ..., space: int = ..., float_format: Optional[Any] = ..., justify: str = ..., decimal: str = ..., quoting: Optional[Any] = ..., fixed_width: bool = ..., leading_space: Optional[Any] = ...) -> None: ...
    def get_result(self): ...
