...
def write_to_compressed(
    compression: Any, path: Any, data: Any, dest: str = ...
) -> None: ...
...
def get_locales(
    prefix: Optional[Any] = ..., normalize: bool = ..., locale_getter: Any = ...
): ...
...
def set_trace() -> None: ...
def ensure_clean(
    filename: Optional[Any] = ..., return_filelike: bool = ...
) -> None: ...
...
def assert_interval_array_equal(
    left: Any, right: Any, exact: str = ..., obj: str = ...
) -> None: ...
...
def raise_assert_detail(
    obj: Any, message: Any, left: Any, right: Any, diff: Optional[Any] = ...
) -> None: ...
...
def assert_panel_equal(
    left: Any,
    right: Any,
    check_dtype: bool = ...,
    check_panel_type: bool = ...,
    check_less_precise: bool = ...,
    check_names: bool = ...,
    by_blocks: bool = ...,
    obj: str = ...,
...
def makeCategoricalIndex(
    k: int = ..., n: int = ..., name: Optional[Any] = ..., **kwargs: Any
): ...
...
def makeDateIndex(
    k: int = ..., freq: str = ..., name: Optional[Any] = ..., **kwargs: Any
): ...
...
def getSeriesData(): ...
def makeTimeSeries(
    nper: Optional[Any] = ..., freq: str = ..., name: Optional[Any] = ...
): ...
...
def makeCustomIndex(
    ...
    prefix: str = ...,
    names: bool = ...,
    ndupe_l: Optional[Any] = ...,
    idx_type: Optional[Any] = ...,
): ...
