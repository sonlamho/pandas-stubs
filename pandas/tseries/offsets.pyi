...
class BusinessDay(BusinessMixin, SingleConstructorOffset):
    def __init__(
        self, n: int = ..., normalize: bool = ..., offset: Any = ...
    ) -> None: ...
    def apply(self, other: Any): ...
    def apply_index(self, i: Any): ...
    def onOffset(self, dt: Any): ...
...
class SemiMonthOffset(DateOffset):
    def __init__(
        self, n: int = ..., normalize: bool = ..., day_of_month: Optional[Any] = ...
    ) -> None: ...
    @property
    def rule_code(self): ...
    def apply(self, other: Any): ...
...
class Week(DateOffset):
    def __init__(
        self, n: int = ..., normalize: bool = ..., weekday: Optional[Any] = ...
    ) -> None: ...
    def isAnchored(self): ...
    def apply(self, other: Any): ...
    def apply_index(self, i: Any): ...
...
class QuarterOffset(DateOffset):
    def __init__(
        self, n: int = ..., normalize: bool = ..., startingMonth: Optional[Any] = ...
    ) -> None: ...
    def isAnchored(self): ...
    @property
    def rule_code(self): ...
...
class YearOffset(DateOffset):
    ...
    def onOffset(self, dt: Any): ...
    def __init__(
        self, n: int = ..., normalize: bool = ..., month: Optional[Any] = ...
    ) -> None: ...
    @property
    def rule_code(self): ...
